      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="credit card">Kaspi</option>
               <option value="paypal">Halyk</option>
               <option value="paytm">Jusan</option>
            </select>
         </div>
         <div class="inputBox">
            <span>address :</span>
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="e.g. aktobe">
         </div>
         <div class="inputBox">
            <span>region :</span>
            <input type="text" name="state" required placeholder="e.g. aktobe">
         </div>
         <div class="inputBox">
            <span>country :</span>
         ...
         <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="0" name="pin_code" required placeholder="e.g. 00120">
         </div>
      </div>
